...
# ACDS 17.0 602 win32 2020.10.01.18:09:01
...
# ----------------------------------------
# If sjpll is one of several IP cores in your
...
TOP_LEVEL_NAME="sjpll"
QSYS_SIMDIR="./../../"
QUARTUS_INSTALL_DIR="D:/intelfpga_lite/17.0/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/sjpll.vo"
fi
