...
DF  TILEMAP_SEL     Select tilemap to be affected by future IO reqs (any value other than 1 is treated as 0) - doesn't affect video mode 2
DE  **** Not used ****
...
4A  DMA_LEN_LO_A    DMA Length low byte - a write here also starts the  Alternative DMA operation (create a 16 x 16 sprite from 4 8 x 8 consecutive tiles)
